...
1. Люди і взаємодія більш важливіші процесів та інструментів;
...
* високий ступінь залучення виконавців, організаторів і замовників проекту;
...
1.	Візуалізація роботи: розділення її на задачі, описання кожної задачі на картці й розміщення на стінці чи дошці. Вище названі стовпці використовуються для того аби наочно зобразити прогрес задачі.
...
Артефактів Канбан не має, ця система може використувати артефакти будь-якої іншої.

***

#### SCRUM 

Scrum є однією з найбільш популярних «методологій» розробки ПЗ. Згідно з визначенням, Scrum - це каркас розробки, з використанням якого люди можуть продуктивно вирішувати  проблеми, при цьому виробляючи продукти найвищої значущості.

Революційний метод управління проектами, виділяє 8 кроків, які допоможуть освоїти і використовувати дану методику:

 1. Вибрати керівника продуктом – йому відома ціль та очікуваний результат.
 2. Зібрати команду (близько 10 осіб), яка володіє потрібними для створення продукту навичками.
 3. Знайти скрам-мастера – він буде слідкувати за процесом і допомагати команді проекту.
 4. Створити беклог продукту – розставити пріоритети по кожній з вимог, тут головна роль саме власника продукту.
 5. Спланувати спринти – визначити часові відрізки які будуть відводитись для виконання конкретних задач.
 6. Організувати щоденні «міт-апи» тривалістю близько 15-30 хвилин – для опитування кожного з учасників про їх успішність і в цілому справи.
 7. Робити огляд працюючих частин продукту, повинні бути притягнуті стек-холдери.
 8. Проводити ретроспективу – обговорювати проблеми та шукати їх вирішення по закінченню кожного спринта.

Завдяки методиці Scrum істотно зростає продуктивність і скорочується час в порівнянні з класичними процесами waterfall. Практикуючи процеси Scrum, організації мають можливість плавної адаптації до мінливих умов, вони можуть робити продукт, який відповідає динамічним бізнес-цілям.

За допомогою Scrum:
- підвищується якість результатів;
- легше сприймаються зміни тощо;
- забезпечуються більш точні оцінки, причому на їх створення йде менше часу;
- ефективніше контролюється сценарій проекту й етапи роботи над ним.

Переваги методології:
* це співпраця: команда працює разом, щоб визначити цілі спринту і досягти цілей;
* допомагає командам брати великі проекти і розбивати їх на більш дрібні, керовані шматки;
* неперервний зворотний зв'язок і команда включає її в наступну версію;
* легше вносити зміни в менші розділи;
* робота в невеликих спринтах підвищує ймовірність того, що команда піймає помилки перед випуском.

Недоліки:

* Scrum може бути абсолютно новим способом ведення справ, і деяким складно адаптуватися;
* всі повинні бути командними гравцями;
* якщо член команди виходить з середини спринту, може бути важко закінчити вчасно;
* не всі люблять щоденні зустрічі.

**Артефакты SCRUM**

**Діаграма зникання завдань (Burndown chart):**

Діаграма, що демонструє кількість зробленої роботи і роботи що залишилась, щодо часу на розробку проекту. Дані діаграми необхідно щодня оновлювати, щоб в реальному часі показувати зрушення і витрати в роботі.

**Журнал побажань проекта (Project backlog):**

Журнал побажань спринту (беклог спринту) - містить функціональність, обрану власником продукту з беклога проекту. Всі функції розбиті за завданнями, кожна з яких оцінюється командою SCRUM.

**Ціль спринта (Sprint Goal):**

Це короткий опис бізнес-цілі, заради якої виконується даний спринт. Мета на спринт допомагає команді приймати бізнес-обґрунтовані рішення. Цей артефакт необхідний для того, щоб команда проекту могла самостійно приймати рішення в разі появи альтернативних шляхів вирішення бізнес-завдання.

**Інкремент продукту:**

Інкремент продукту — це готовий продукт в кінці спринту. Показують зацікавленим особам на демонстрації, щоб зібрати відгуки і вирішити, що робити з продуктом дальшe.

**Історія користувача (User Story):**

Необхідну бізнес-функціональність, яку додають в беклог проекту, часто називають історією. Найчастіше історія має наступну структуру: «Будучи користувачем <тип користувача> я хочу зробити <дію>, щоб отримати <результат>». Така структура зручна тим, що зрозуміла як розробникам, так і замовникам.

**Зупинка спринта (Abnormal Termination):**

Спринт може зупинити команда, якщо розуміє, що не може досягти мети спринту у відведений час. Спринт може зупинити менеджер-майстер або власник продукту.

**Задачі історї спринта (Sprint Story Tasks):**

Виконання кожного завдання оцінюється в годиннику. Кожне завдання не повинна перевищувати 12 годин (найчастіше команда наполягає, щоб максимальна тривалість завдання дорівнювала одному робочому дню).

**Критерій готовності (Definition of Done, DoD):**
Критерії, що визначають ступінь готовності елемента з беклога користувача.

**Швидкість команди SCRUM (Velocity):**

Загальна кількість очок, набраних командою SCRUM за попередній спринт. Дана метрика допомагає команді зрозуміти, скільки історій вона може зробити за один спринт.
...
| Своєчасне оновлення                                           | ✓     | ✓        | ✓            | ✓               | ✓               |
| Інтеграції зі сторонніми серверами                            | Jira, Hubstaff, GitHub, Harvest, DigiSpoke, Slack, Zapier| Invision, Zapier|Slack, GitKraken Glo Boards, Circle CI, Git, TravisCI | Zapier, Slack, GitHub, Jira, BlueJeans Meetings | Confluence, Bitbucket, Slack, GitHub,  Subversion, CVS, Git, Clearcase, Team Foundation Server, Mercurial и Perforce|
