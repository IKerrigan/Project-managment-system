...
В цьому документі надана можливість ознайомитися з основними підходами та способами вирішення завдання на основі методів управління прєктами та за аналогією до подібних архітектурних програм, надана порівняльна характеристика існуючих засобів, та перелік термінів, що використовуються у тексті аналізу.
...
Провівши аналіз предметної області, ми вирішили, що врахувавши усі недоліки та прогалини уже існуючих засобів, ми маємо змогу створити систему, що буде близька до досконалої  за усіма розглянутими характеристиками. За опорну систеиу керування проектами ми вибрали Trello.
