...
**Передумова:** Завдання попередньо створене Користувачем у Системі

**Результат:** Редаговане завдання у системі. 

**Виключні ситуації:**

- EX.07.01  Попередньо створене Користувачем завдання не було збережено
- EX.07.02  Завдання було видалене із системи
